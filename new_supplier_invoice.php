...
<form action="insertNewSupplierInvoice.php" method="post" onSubmit="return validateForm()">
  <div class='metadata'>
    <label for="Supplier_Invoice_ID">Supplier Invoice ID</label>
    <input type='text' id="Supplier_Invoice_ID" name='Supplier_Invoice_ID'>
  </div>
  <div class='metadata'>
  ...
  <div class='metadata'>
    <label for="ICIC_Number">ICIC Number</label>
    <input type='text' id="ICIC_Number" name='ICIC_Number'>
  </div>
  <div class='metadata'>
