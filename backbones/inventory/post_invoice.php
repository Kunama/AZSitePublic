...
$query = $myPDO->prepare("INSERT INTO `Inventory` (`AZ_PO`, `AZ_Invoice`, `Item_ID`, `Number_of_Cartons`) SELECT `AZ PO`, `AZ INVOICE`, `ItemID`, `No of Cartons` FROM `Invoice_Items` WHERE `AZ INVOICE` = :curinvoice");
